...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    delta1 = get_lat(city1)-get_lat(city2)
    delta2 = get_lon(city1)-get_lon(city2)
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    temp_city = make_city('tem_city',lat,lon)
    distance1 = distance(city1,temp_city)
    distance2 = distance(city2,temp_city)
