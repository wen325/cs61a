...
class Player(object):
    ...
    def take(self, thing):
        ...
        if type(thing) != str:
            ...
            taken_object = self.place.take(thing)
            # self.backpack += taken_object
            self.backpack.append(taken_object)
            # print(self.backpack)
    ...
    def unlock(self, place):
        ...
        open_place = self.place.get_neighbor(place)
        if open_place.locked == False:
