...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls>0:
        ...
        pig_check = 10*pig_check + points
        num_rolls -=1    
        
    while pig_check>0:
        if pig_check %10 ==1:
           return 1
        pig_check = pig_check//10
    return sum_points
    # END PROBLEM 1
...
def free_bacon(score):
    ...
    score_1 = score //10
    score_2 = score % 10
    return basic_points+abs(score_1-score_2)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if gain > previous_high:
                ...
                return announce_highest(who,gain,now_score)
        else:
...
def make_averaged(fn, num_samples=1000):
    ...
    def average(*args):
        i, total_points = 0,0
        while i< num_samples:
            total_points += fn(*args)
            i += 1
        return total_points/num_samples
    return average
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    highest_average, i, j = 0, 1, 0
    while i < 11:
            average_point = make_averaged(roll_dice)(i,dice)
            if average_point > highest_average:
                highest_average = average_point
                i +=1
                j +=1
            else:
                i +=1
...
def swap_strategy(score, opponent_score, margin=11, num_rolls=10):
    ...
    if take_turn(0 , opponent_score) >= margin:
        return 0
    elif opponent_score % (score+take_turn(0 , opponent_score))==0:
        return 0
    return num_rolls  # Replace this statement
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if opponent_score % (score+take_turn(0 , opponent_score))==0:
        return 0
    elif score < 50:
        return swap_strategy(score, opponent_score)
    elif score < 70: 
        return always_roll(5)(score, opponent_score)
    elif score < 90:
        return always_roll(3)(score, opponent_score)
    else:
